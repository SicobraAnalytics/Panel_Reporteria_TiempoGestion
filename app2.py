...
st.set_page_config(page_title="Reporte Tiempo Sin Gestión r", layout="wide")
...
@st.cache_data
def load_data():
    adherencia = pd.read_csv("DataFinal/adherencia_final_2025-11-19.csv", encoding="latin-1")
...
def calcular_exceso(row):
    ...
    # BREAK
    if row["TipoContrato"] == "Jornada Parcial":
